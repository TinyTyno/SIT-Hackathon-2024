...
function ViewStock() {
    ...
    return (
        <div class="container" style={{margin:'auto'}}>
            <StableSidebar />
            <SearchStock />
            <ResizablePanelGroup direction="horizontal" className="w-[100vw]" style={{ width: '80vw', margin:'auto', marginLeft:'70px'}}>
            <ResizablePanel>
            ...
            <ResizablePanel defaultSize={29} minSize={24}>
                ...
                <div className="flex space-x-4">
                    <HoverCard>
                        <HoverCardTrigger>
                            <Button className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600" onClick={() => navigate(`../../buyStock/${symbol}`)}>
                            Buy
                            </Button>
                        </HoverCardTrigger>
                    ...
                    <HoverCard>
                        <HoverCardTrigger>
                            <Button className="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600" onClick={() => navigate(`../../sellStock/${symbol}`)}>
                            Sell
                            </Button>
                        </HoverCardTrigger>
                        <HoverCardContent className="text-xs">
            ...
            <ResizablePanelGroup direction="horizontal" className="border w-[100vw]" style={{ width: '80vw', margin:'auto', marginLeft:'70px'}}>
